...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_14 uint8_t blockSize( Format format )
  {
    switch ( format )
    {
      ...
      case Format::eR16G16S105NV                        : return 4;
      case Format::eA1B5G5R5UnormPack16KHR              : return 2;
      case Format::eA8UnormKHR                          : return 1;
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_14 char const * compatibilityClass( Format format )
  {
    switch ( format )
    {
      ...
      case Format::eR16G16S105NV                        : return "32-bit";
      case Format::eA1B5G5R5UnormPack16KHR              : return "16-bit";
      case Format::eA8UnormKHR                          : return "8-bit alpha";
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_14 uint8_t componentCount( Format format )
  {
    switch ( format )
    {
      ...
      case Format::eR16G16S105NV                        : return 2;
      case Format::eA1B5G5R5UnormPack16KHR              : return 4;
      case Format::eA8UnormKHR                          : return 1;
  ...
  VULKAN_HPP_INLINE std::vector<Format> const & getAllFormats()
  {
    static std::vector<Format> allFormats = { Format::eR4G4UnormPack8,
                                              ...
                                              Format::eR16G16S105NV,
                                              Format::eA1B5G5R5UnormPack16KHR,
                                              Format::eA8UnormKHR };
    return allFormats;
  }
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_14 bool hasAlphaComponent( Format format )
  {
    switch ( format )
    {
      ...
      case Format::ePvrtc24BppSrgbBlockIMG:
      case Format::eA1B5G5R5UnormPack16KHR:
      case Format::eA8UnormKHR                      : return true;
      default                                       : return false;
    }
  }
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_14 bool hasBlueComponent( Format format )
  {
    switch ( format )
    {
      ...
      case Format::ePvrtc22BppSrgbBlockIMG:
      case Format::ePvrtc24BppSrgbBlockIMG:
      case Format::eA1B5G5R5UnormPack16KHR              : return true;
      default                                           : return false;
    }
  }
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_14 uint8_t packed( Format format )
  {
    switch ( format )
    {
      ...
      case Format::eA1B5G5R5UnormPack16KHR              : return 16;
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_14 uint8_t texelsPerBlock( Format format )
  {
    switch ( format )
    {
      ...
      case Format::eR16G16S105NV                        : return 1;
      case Format::eA1B5G5R5UnormPack16KHR              : return 1;
      case Format::eA8UnormKHR                          : return 1;
